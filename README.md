...
- Hand gesture-to-gesture translation: **[Inception Score](https://github.com/openai/improved-gan) | [Fréchet Inception Distance (FID)](https://github.com/bioinf-jku/TTUR) | [PSNR](https://github.com/Ha0Tang/SelectionGAN/blob/master/scripts/evaluation/compute_ssim_psnr_sharpness.lua), need install `Lua` **
